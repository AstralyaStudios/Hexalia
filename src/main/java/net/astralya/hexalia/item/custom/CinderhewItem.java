...
public final class CinderhewItem extends AxeItem {
    ...
    public CinderhewItem(Tier tier, float attackDamage, float attackSpeed, Properties properties) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            CinderhewProjectile projectile = new CinderhewProjectile(ModEntities.CINDERHEW.get(), level, player, thrownStack);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.hexalia.cinderhew.fire_damage").withStyle(ChatFormatting.GOLD));
        tooltip.add(Component.translatable("tooltip.hexalia.throwable").withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
    }
}
