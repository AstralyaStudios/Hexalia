...
import net.astralya.hexalia.client.renderer.item.MoonweaveMantleRenderer;
...
public class MoonweaveMantleItem extends ArmorItem implements GeoItem, MagicResistanceArmor {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public MoonweaveMantleItem(ArmorMaterial material, Type type, Settings settings) {
        ...
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack stack, EquipmentSlot slot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null) {
                    this.renderer = new MoonweaveMantleRenderer();
                }
