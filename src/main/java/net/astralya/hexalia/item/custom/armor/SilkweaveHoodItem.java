...
public class SilkweaveHoodItem extends ArmorItem implements GeoItem, MagicResistanceArmor {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public SilkweaveHoodItem(ArmorMaterial material, Type type, Settings settings) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack stack, EquipmentSlot slot, BipedEntityModel<LivingEntity> original) {
                if (renderer == null) {
                    renderer = new SilkweaveHoodRenderer();
                }
