...
public class SilkweaveFootwrapsItem extends ArmorItem implements GeoItem, MagicResistanceArmor {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public SilkweaveFootwrapsItem(ArmorMaterial material, Type type, Settings settings) {
